...
export default function About() {
  return (
    <div className="min-h-screen w-full bg-gradient-to-b from-gray-100 to-gray-300 flex flex-col items-center justify-center px-4 sm:px-6 lg:px-12 py-12">
      
      {/* Header Section */}
      <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-gray-800 mb-6 font-serif text-center">
        About <span className="text-blue-600">HuntingCoder</span>
      </h1>
      <p className="text-base sm:text-lg md:text-xl text-gray-600 max-w-3xl text-center mb-10 px-2">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl w-full px-2">
        <div className="bg-white rounded-2xl shadow-lg p-6 hover:shadow-2xl transition duration-300">
          <h2 className="text-lg sm:text-xl font-bold text-blue-600 mb-2">Our Mission</h2>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 hover:shadow-2xl transition duration-300">
          <h2 className="text-lg sm:text-xl font-bold text-blue-600 mb-2">What We Offer</h2>
          <p className="text-gray-700 text-sm sm:text-base">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 hover:shadow-2xl transition duration-300">
          <h2 className="text-lg sm:text-xl font-bold text-blue-600 mb-2">Our Vision</h2>
          <p className="text-gray-700 text-sm sm:text-base">
      ...
      {/* Closing Section */}
      <div className="mt-12 max-w-3xl text-center px-2">
